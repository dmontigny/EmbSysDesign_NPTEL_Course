...
#define LED BIT0                        // Led Pin

#define SW1 BIT4                        // 1.5Khz
#define SW2 BIT6                        // 3Khz
#define SW3 BIT7                        // 12Khz
...
void register_settings_for_GPIO()
{
    P1DIR |= LED;                       //P1.0 is set as Output
    P1DIR &=~ (SW1 + SW2 + SW3);        //P1.4, P1.6, P1.7 are set as Input
}
